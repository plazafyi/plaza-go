...
func TestDatasetNewWithOptionalParams(t *testing.T) {
	...
	_, err := client.Datasets.New(context.TODO(), githubcomplazafyiplazago.DatasetNewParams{
		...
		StrictMode:  githubcomplazafyiplazago.F(true),
	})
	if err != nil {
...
func TestDatasetListWithOptionalParams(t *testing.T) {
	...
	_, err := client.Datasets.List(context.TODO(), githubcomplazafyiplazago.DatasetListParams{
		Scope: githubcomplazafyiplazago.F("scope"),
	})
	if err != nil {
		var apierr *githubcomplazafyiplazago.Error
		if errors.As(err, &apierr) {
