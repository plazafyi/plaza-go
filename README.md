...
```go
import (
	"github.com/plazafyi/plaza-go" // imported as plaza
)
```
...
```sh
go get -u 'github.com/plazafyi/plaza-go@v0.0.2'
```
...
See the [full list of request options](https://pkg.go.dev/github.com/plazafyi/plaza-go/option).
