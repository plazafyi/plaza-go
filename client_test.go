...
func TestUserAgentHeader(t *testing.T) {
	...
	_, _ = client.Features.Query(context.Background(), githubcomplazafyiplazago.FeatureQueryParams{})
...
func TestRetryAfter(t *testing.T) {
	...
	_, err := client.Features.Query(context.Background(), githubcomplazafyiplazago.FeatureQueryParams{})
	if err == nil {
...
func TestContextCancel(t *testing.T) {
	...
	cancel()
	_, err := client.Features.Query(cancelCtx, githubcomplazafyiplazago.FeatureQueryParams{})
	if err == nil {
		t.Error("Expected there to be a cancel error")
	}
}
...
func TestContextDeadline(t *testing.T) {
	...
	go func() {
		...
		_, err := client.Features.Query(deadlineCtx, githubcomplazafyiplazago.FeatureQueryParams{})
		if err == nil {
